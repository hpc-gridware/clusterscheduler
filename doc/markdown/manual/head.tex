% common settings for generating manuals
% inspired from https://jdhao.github.io/2019/05/30/markdown2pdf_pandoc/

\usepackage[most]{tcolorbox}
\usepackage{listings}

% general setting for listings
\lstset{                  
  columns=fixed,
  basicstyle=\ttfamily,
  frame=single,
...
\definecolor{bgcolor}{RGB}{224,215,188}
\let\oldtexttt\texttt
...
\definecolor{backquote}{RGB}{255,242,204}
...
% make sure a section starts on a new page
\usepackage{titlesec}
