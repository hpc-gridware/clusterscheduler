...
xxQS_NAMExx components on the other axis. Find footnotes below the next two tables for further explanations of
the symbols/letter used in the table.
...
|:-----------------|:--------|:-------------|:---------------------:|:-----------------:|:--------------------:|
| macOS            | 14      | ARM64        |           -           |         -         |          s           |
| CentOS Linux     | 6       | x86-64       |           -           |         s         |          s           |
| Redhat Linux     | 6       | x86-64       |           s           |         s         |          s           |
| Solaris          | 11      | x86-64       |           s           |         s         |          s           |
| OmniOS           | 11      | x86-64       |           s           |         s         |          s           |
| OpenIndiana      | 11      | x86-64       |           s           |         s         |          s           |
  ...
  s: Ask our sales and support team for availability and support options if you need this configuration.
