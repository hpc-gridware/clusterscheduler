...
/** @file
 * @brief Localisable message catalogue shared by the daemons
 */
...
#define MSG_ALIAS_INVALIDSYNTAXOFPATHALIASFILEX_S              _MESSAGE(27005, _("invalid syntax of path alias file " PFQMAX))
#define MSG_ALIAS_CANTREAD_SS                                  _MESSAGE(27006, _("can't read path aliasing file " PFQMAX ": " SFN))
...
#define MSG_HEART_CANNOT_FSEEK_SS            _MESSAGE(27092, _("can't seek to the beginning of heartbeat file " PFQMAX ": " SFN))
#define MSG_HEART_NO_FILENAME                _MESSAGE(27093, _("no heartbeat file name specified"))
#define MSG_HEART_WRITE_ERROR_SS             _MESSAGE(27094, _("can't write data to heartbeat file " PFQMAX ": " SFN))
#define MSG_HEART_CLOSE_ERROR_SS             _MESSAGE(27095, _("error closing heartbeat file " PFQMAX ": " SFN))
#define MSG_HEART_WRITE_TIMEOUT_S            _MESSAGE(27096, _("got timeout error while write data to heartbeat file " PFQMAX))
// @todo CS-1545 shouldn't it be heartbeat instead of act_qmaster?
#define MSG_HEART_CANNOT_READ_FILE_S         _MESSAGE(27097, _("can't read act_qmaster file: " PFNMAX))
#define MSG_HEART_ACT_QMASTER_FILE_CHANGED   _MESSAGE(27098, _("act_qmaster file has been changed by another qmaster"))
#define MSG_HEART_READ_TIMEOUT_S             _MESSAGE(27099, _("got timeout error while read data from heartbeat file " PFQMAX))
#define MSG_HEART_CANT_SIGNAL                _MESSAGE(27100, _("can't send signal to signal thread"))
#define MSG_HEART_CANNOTOPEN_SS              _MESSAGE(27101, _("can't open heartbeat file " PFQMAX ": " SFN))
