...
#define MSG_MAIL_STARTSUBJECT_UUS     "Job-array task " sge_uu32 "." sge_uu32 " (" SFN ") Started"
#define MSG_MAIL_STARTSUBJECT_US      "Job " sge_uu32 " (" SFN ") Started"
...
#define MSG_JOB_XREGISTERINGJOBYATPTFDURINGSTARTUP_SU       _MESSAGE(29002, _(SFN " registering job \"" sge_uu32 "\" at ptf during startup"))
#define MSG_FAILED                                          _MESSAGE(29003, _("failed"))
#define MSG_DELAYED                                         _MESSAGE(29004, _("delayed"))
#define MSG_JOB_XREGISTERINGJOBYTASKZATPTFDURINGSTARTUP_SUS _MESSAGE(29005, _(SFN " registering job \"" sge_uu32 "\" task " SFN " at ptf during startup"))

#define MSG_SLAVE                                           _MESSAGE(29008, _("slave "))
#define MSG_COREDUMPED                                      _MESSAGE(29009, _("(core dumped) "))
#define MSG_WAITPIDNOSIGNOEXIT_UI                           _MESSAGE(29010, _("waitpid() returned for pid " sge_uu32 " status %d unequal WIFSIGNALED/WIFEXITED"))
#define MSG_SHEPHERD_VSHEPHERDOFJOBWXDIEDTHROUGHSIGNALYZ_SUUSI    _MESSAGE(29011, _(SFN "shepherd of job " sge_uu32 "." sge_uu32 " died through signal " SFN "= %d"))
#define MSG_SHEPHERD_WSHEPHERDOFJOBXYEXITEDWITHSTATUSZ_SUUI       _MESSAGE(29012, _(SFN "shepherd of job " sge_uu32 "." sge_uu32 " exited with exit status = %d"))
#define MSG_JOB_MISSINGJOBXYINJOBREPORTFOREXITINGJOBADDINGIT_UU   _MESSAGE(29013, _("missing job " sge_uu32 "." sge_uu32 " in job report for exiting job - adding it"))
...
#define MSG_JOB_REAPINGJOBXPTFCOMPLAINSY_US                 _MESSAGE(29018, _("reaping job \"" sge_uu32 "\" ptf complains: " SFN))
...
#define MSG_SHEPHERD_REMOVEACKEDJOBEXITCALLEDWITHX_U        _MESSAGE(29032, _("remove_acked_job_exit called with " sge_uu32 ".0"))
#define MSG_JOB_XYHASNOTASKZ_UUS                            _MESSAGE(29033, _("job " sge_uu32 "." sge_uu32 " has no task " SFQ))

#define MSG_FILE_CANTREMOVEDIRECTORY_SS                     _MESSAGE(29037, _("can't remove directory " SFQ ": " SFN))
#define MSG_SHEPHERD_ACKNOWLEDGEFORUNKNOWNJOBXYZ_UUS        _MESSAGE(29038, _("acknowledge for unknown job " sge_uu32 "." sge_uu32 "/" SFN))
#define MSG_SHEPHERD_NOMOREOLDJOBSAFTERSTARTUP               _MESSAGE(29039, _("no more old jobs after startup"))
#define MSG_SHEPHERD_CANTFINDACTIVEJOBSDIRXFORREAPINGJOBY_SU  _MESSAGE(29040, _("can't find active jobs directory " SFQ " for reaping job " sge_uu32 ))
#define MSG_SHEPHERD_INCORRECTCONFIGFILEFORJOBXY_UU         _MESSAGE(29041, _("incorrect config file for job " sge_uu32 "." sge_uu32 ""))
#define MSG_SHEPHERD_CANTSTARTJOBXY_US                      _MESSAGE(29042, _("can't start job \"" sge_uu32 "\": " SFN))
#define MSG_SHEPHERD_PROBLEMSAFTERSTART_DS                  _MESSAGE(29043, _("problems after job start \"" sge_uu32 "\": " SFN))
#define MSG_SHEPHERD_JATASKXYISKNOWNREPORTINGITTOQMASTER    _MESSAGE(29044, _("ja-task \"" sge_uu32 "." sge_uu32 "\" is unknown - reporting it to qmaster"))
...
#define MSG_SHEPHERD_MISSINGJOBXINJOBREPORTFOREXITINGJOB_U  _MESSAGE(29054, _("missing job \"" sge_uu32 "\" in job report for exiting job"))
...
#define MSG_SHEPHERD_SHEPHERDFORJOBXHASPIDYANDISZALIVE_SU   _MESSAGE(29056, _("shepherd for job " SFN " has pid \"" sge_uu32 "\" and is alive"))
#define MSG_SHEPHERD_SHEPHERDFORJOBXHASPIDYANDISNOTALIVE_SU _MESSAGE(29057, _("shepherd for job " SFN " has pid \"" sge_uu32 "\" and is not alive"))

#define MSG_SHEPHERD_INCONSISTENTDATAFORJOBX_U              _MESSAGE(29058, _("inconsistent data for job \"" sge_uu32 "\""))
#define MSG_SHEPHERD_MISSINGJOBXYINJOBREPORT_UU             _MESSAGE(29059, _("Missing job " sge_uu32 "." sge_uu32 " in job report"))
#define MSG_SHEPHERD_CANTOPENPIDFILEXFORJOBYZ_SUU           _MESSAGE(29060, _("can't open pid file " SFQ " for job " sge_uu32 "." sge_uu32))
#define MSG_SHEPHERD_CANTOPENUSAGEFILEXFORJOBYZX_SUUS       _MESSAGE(29061, _("can't open usage file " SFQ " for job " sge_uu32 "." sge_uu32 ": " SFN))
#define MSG_SHEPHERD_EXECDWENTDOWNDURINGJOBSTART            _MESSAGE(29062, _("execd went down during job start"))
#define MSG_EXECD_ERRORREADINGPIDOFJOB_UU                   _MESSAGE(29063, _("error reading pid for job " sge_uu32 "." sge_uu32))
...
#define MSG_PRIO_JOBXPIDYSETPRIORITYFAILURE_UUS             _MESSAGE(29072, _("job " sge_uu32 " pid " sge_uu32 " setpriority failure: " SFN))
...
#define MSG_PARSE_USAGEATTR_SSU        _MESSAGE(29092, _("failed parsing " SFQ " passed as usage attribute " SFQ " of job " sge_uu32))
...
#define MSG_MAIL_MAILLISTTOOLONG_U     _MESSAGE(29104, _("maillist for job " sge_uu32 " too long"))
...
#define MSG_MAIL_STARTBODY_UUSSSSS     _MESSAGE(29116, _("Job-array task " sge_uu32 "." sge_uu32 " (" SFN ") Started\n User       = " SFN "\n Queue      = " SFN "\n Host       = " SFN "\n Start Time = " SFN))
#define MSG_MAIL_STARTBODY_USSSSS      _MESSAGE(29117, _("Job " sge_uu32 " (" SFN ") Started\n User       = " SFN "\n Queue      = " SFN "\n Host       = " SFN "\n Start Time = " SFN))
...
#define MSG_JOB_EXCEEDHLIM_USSFF       _MESSAGE(29126, _("job " sge_uu32 " exceeds job hard limit " SFQ " of queue " SFQ " (%8.5f > limit:%8.5f) - sending SIGKILL"))
#define MSG_JOB_EXCEEDSLIM_USSFF       _MESSAGE(29127, _("job " sge_uu32 " exceeds job soft limit " SFQ " of queue " SFQ " (%8.5f > limit:%8.5f) - sending SIGXCPU"))
#define MSG_EXECD_EXCEEDHWALLCLOCK_UU  _MESSAGE(29128, _("job " sge_uu32 "." sge_uu32 " exceeded hard wallclock time - initiate terminate method"))
#define MSG_EXECD_EXCEEDSWALLCLOCK_UU  _MESSAGE(29129, _("job " sge_uu32 "." sge_uu32 " exceeded soft wallclock time - initiate soft notify method"))
...
#define MSG_JOB_MISSINGQINGDIL_SU      _MESSAGE(29138, _("missing queue " SFQ " found in gdil of job " sge_uu32))
#define MSG_EXECD_NOWRITESCRIPT_SIUS   _MESSAGE(29139, _("can't write script file " SFQ " wrote only %d of " sge_uu32 " bytes: " SFN))
#define MSG_JOB_TASKWITHOUTJOB_U       _MESSAGE(29140, _("received task belongs to job " sge_uu32 " but this job is not here"))
#define MSG_JOB_TASKNOTASKINJOB_UU     _MESSAGE(29141, _("received task belongs to job " sge_uu32 " but this job is here but the JobArray task " sge_uu32 " is not here"))
#define MSG_JOB_TASKNOSUITABLEJOB_U    _MESSAGE(29142, _("received task belongs to job " sge_uu32 " but this job is not suited for starting tasks"))

#define MSG_JOB_NOFREEQ_USSS           _MESSAGE(29145, _("no free queue for job " sge_uu32 " of user " SFN "@" SFN " (localhost = " SFN ")"))
...
#define MSG_JOB_INITCKPTSHUTDOWN_U     _MESSAGE(29149, _("initiate checkpoint at shutdown: job " sge_uu32 ""))
#define MSG_JOB_KILLSHUTDOWN_U         _MESSAGE(29150, _("killing job at shutdown: job " sge_uu32 ""))
#define MSG_JOB_INITMIGRSUSPQ_U        _MESSAGE(29151, _("initiate migration at queue suspend for job " sge_uu32))
#define MSG_JOB_SIGNALTASK_UUS         _MESSAGE(29152, _("SIGNAL jid: " sge_uu32 " jatask: " sge_uu32 " signal: " SFN))
...
#define MSG_JOB_INITMIGRSUSPJ_UU       _MESSAGE(29155, _("initiate migration at job suspend for job " sge_uu32 " task " sge_uu32 ""))
...
#define MSG_EXECD_ENABLEDELEAYDREPORTINGFORJOB_U   _MESSAGE(29192, _("Enable delayed job reporting for job " sge_uu32 ""))
...
#define MSG_SGE_KILLINGPIDXY_UI                          _MESSAGE(29218, _("killing pid " sge_uu32 "/%d" ))
#define MSG_SGE_DONOTKILLROOTPROCESSXY_UI                _MESSAGE(29219, _("do not kill root process " sge_uu32 "/%d"   ))
