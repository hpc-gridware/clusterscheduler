...
/** @file
 * @brief Localisable message catalogue of the execution daemon
 */
...
#define MSG_FILE_RECURSIVERMDIR_SS                          _MESSAGE(29001, _("recursive rmdir(" PFNMAX "): " SFN))
...
#define MSG_JOB_CANTFINDDIRXFORREAPINGJOBYZ_SS              _MESSAGE(29020, _("can't find directory " PFNMAX " for reaping job " SFN))
...
#define MSG_FILE_CANTREMOVEDIRECTORY_SS                     _MESSAGE(29037, _("can't remove directory " PFQMAX ": " SFN))
...
#define MSG_SHEPHERD_CANTFINDACTIVEJOBSDIRXFORREAPINGJOBY_SU  _MESSAGE(29040, _("can't find active jobs directory " PFQMAX " for reaping job " sge_u32 ))
...
#define MSG_SHEPHERD_FOUNDACTIVEJOBDIRXWHILEMISSINGJOBDIRREMOVING_S    _MESSAGE(29049, _("found active job directory " PFQMAX " while missing job directory - removing"))
...
#define MSG_SHEPHERD_CANTREADPIDFILEXFORJOBYSTARTTIMEZX_SSSS _MESSAGE(29053, _("can't read pid file " PFQMAX " of shepherd for job " SFQ " - starttime: " SFN " cleaning up: " SFN))
...
#define MSG_SHEPHERD_CANTREADPIDFROMPIDFILEXFORJOBY_SS      _MESSAGE(29055, _("can't read pid from pid file " PFQMAX " of shepherd for job " SFN))
...
#define MSG_SHEPHERD_CANTOPENPIDFILEXFORJOBYZ_SUU           _MESSAGE(29060, _("can't open pid file " PFQMAX " for job " sge_u32 "." sge_u32))
...
#define MSG_FILE_RMDIR_SS              _MESSAGE(29098, _("can't remove directory " PFQMAX ": " SFN))

#define MSG_FILE_CREATEDIR_SS          _MESSAGE(29100, _("can't create directory " PFNMAX ": " SFN))
...
#define MSG_EXECD_NOWRITETOKEN_S       _MESSAGE(29115, _("can't write token to token file: " PFNMAX))
...
#define MSG_EXECD_UNABLETOFINDSCRIPTFILE_SS  _MESSAGE(29125, _("unable to find script file " PFNMAX ": " SFN))
...
#define MSG_EXECD_NOADDGIDOPEN_SSS     _MESSAGE(29130, _("failed opening addgrpid file " PFNMAX " of job " SFN ": " SFN))
#define MSG_JOB_NOREGISTERPTF_SS       _MESSAGE(29131, _("failed registering job " SFN " at ptf: " SFN))
#define MSG_EXECD_NOOSJOBIDOPEN_SSS    _MESSAGE(29132, _("failed opening os jobid file " PFNMAX " of job " SFN ": " SFN))
#define MSG_EXECD_UNABLETOCREATECERTFILE_S  _MESSAGE(29133, _("unable to create cert file: " PFNMAX))
...
#define MSG_EXECD_NOWRITESCRIPT_SIUS   _MESSAGE(29139, _("can't write script file " PFQMAX " wrote only %d of " sge_u32 " bytes: " SFN))
...
#define MSG_EXECD_WRITESIGNALFILE_S    _MESSAGE(29153, _("error writing file " PFNMAX " for signal transfer to shepherd"))
...
#define MSG_LS_NOMODTIME_SS            _MESSAGE(29165, _("can't get mod_time from load sensor file " PFNMAX ": " SFN))
