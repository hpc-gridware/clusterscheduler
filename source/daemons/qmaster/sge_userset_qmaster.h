...
int
userset_mod(sge_gdi_packet_class_t *packet, sge_gdi_task_class_t *task, lList **alpp, lListElem *new_userset, lListElem *userset, int add,
            const char *ruser, const char *rhost, gdi_object_t *object, int sub_command, monitoring_t *monitor);

int
userset_spool(sge_gdi_packet_class_t *packet, sge_gdi_task_class_t *task, lList **alpp, lListElem *userset, gdi_object_t *object);

int
userset_success(sge_gdi_packet_class_t *packet, sge_gdi_task_class_t *task, lListElem *ep, lListElem *old_ep, gdi_object_t *object, lList **ppList,
