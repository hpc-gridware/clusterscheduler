...
int
calendar_mod(lList **alpp, lListElem *new_cal, lListElem *cep, int add, const char *ruser,
...
int
calendar_update_queue_states(lListElem *cep, lListElem *old_cep, gdi_object_t *object,
                             lList **ppList, monitoring_t *monitor);

int
sge_del_calendar(lListElem *ep, lList **alpp, char *ruser, char *rhost);
