...
static bool
cqueue_add_qinstances(ocs::GdiPacket *packet, ocs::GdiTask *task, lListElem *cqueue, lList **answer_list, lList *add_hosts,
                      monitoring_t *monitor, const lList *master_hgroup_list, lList *master_cqueue_list);

static lListElem *
qinstance_create(ocs::GdiPacket *packet, ocs::GdiTask *task, const lListElem *cqueue, lList **answer_list, const char *hostname,
...
int
cqueue_success(ocs::GdiPacket *packet, ocs::GdiTask *task, lListElem *cqueue, lListElem *old_cqueue, gdi_object_t *object, lList **ppList, monitoring_t *monitor) {
...
int
cqueue_spool(ocs::GdiPacket *packet, ocs::GdiTask *task, lList **answer_list, lListElem *cqueue, gdi_object_t *object) {
   int ret = 0;
...
int
cqueue_del(ocs::GdiPacket *packet, ocs::GdiTask *task, lListElem *this_elem, lList **answer_list, char *remote_user, char *remote_host) {
   bool ret = true;
   lList *master_cqueue_list = *ocs::DataStore::get_master_list_rw(SGE_TYPE_CQUEUE);
