...
int
ckpt_spool(sge_gdi_packet_class_t *packet, sge_gdi_task_class_t *task, lList **alpp, lListElem *ep, gdi_object_t *object);
...
int
sge_del_ckpt(sge_gdi_packet_class_t *packet, sge_gdi_task_class_t *task, lListElem *, lList **, char *, char *);
