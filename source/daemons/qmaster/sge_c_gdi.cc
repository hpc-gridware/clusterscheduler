 ...
 *
 *       CS-2633. The checks below resolve the manager and operator lists and the
 *       admin and submit host lists in the data store of the calling thread. The
 *       mirror thread of that store removes and frees elements while merging
 *       events, so THE CALLER MUST HOLD THE READ LOCK of the store it is bound to
 *       - LOCK_LISTENER in the listener threads.
 *
