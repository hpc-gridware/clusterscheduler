...
int
sge_add_job_category(lListElem *job, const lList *acl_list, const lList *prj_list, const lList *lirs_list);
...
int
sge_rebuild_job_category(const lList *job_list, const lList *acl_list, const lList *prj_list, const lList *lirs_list);
