...
#define MSG_ERRORFLUSHINGFILE_SS          _MESSAGE(60206, _("error flushing file " SFQ ": " SFN))
#define MSG_ERRORWRITINGFILE_SS           _MESSAGE(60207, _("error writing to file " SFQ ": " SFN))
#define MSG_ERRORFSYNCINGFILE_SS          _MESSAGE(60208, _("error syncing file " SFQ " to disk: " SFN))
