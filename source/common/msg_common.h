...
/** @file
 * @brief Message strings shared by more than one program
 */
...
#define MSG_FILE_CHDIR_SS                                _MESSAGE(23011, _("can't change dir to " PFNMAX ": " SFN))
#define MSG_FILE_NOCHOWN_SS                              _MESSAGE(23012, _("can't chown file or directory " PFNMAX ": " SFN))
#define MSG_FILE_NOCLOSE_SS                              _MESSAGE(23013, _("can't close file " PFNMAX ": " SFN))
#define MSG_FILE_CANTOPENDIRECTORYX_SS                   _MESSAGE(23014, _("can't open directory " PFQMAX ": " SFN))
...
#define MSG_FILE_NOOPEN_SS                               _MESSAGE(23018, _("can't open file " PFNMAX ": " SFN))
...
#define MSG_FILE_CANNOT_WRITE_SS                         _MESSAGE(23030, _("unable to write to file " PFNMAX ": " SFN))
#define MSG_FILE_CANNOT_FLUSH_SS                         _MESSAGE(23031, _("unable to flush file " PFNMAX ": " SFN))
...
#define MSG_ANSWER_ERRORREADINGFROMFILEX_S  _MESSAGE(23042, _("error reading from file " PFNMAX))
...
#define MSG_PARSE_WRONGPATHLISTFORMATXSPECTOEOPTION_S       _MESSAGE(23077, _("ERROR! Wrong path list format " PFQMAX " specified to -e option"))
...
#define MSG_PARSE_WRONGSTDOUTPATHLISTFORMATXSPECTOOOPTION_S _MESSAGE(23087, _("ERROR! Wrong stdout path list format " PFQMAX " specified to -o option"))
...
#define MSG_FILE_EDITFILEXDOESNOTEXIST_S           _MESSAGE(23157, _("edit file " PFNMAX " does not exist"))
#define MSG_QCONF_EDITOREXITEDWITHERROR_I          _MESSAGE(23158, _("editor exited with error %d"))
#define MSG_QCONF_EDITFILEXNOLONGEREXISTS_S        _MESSAGE(23159, _("edit file " PFNMAX " no longer exists"))
...
#define MSG_FILE_ERRORREADINGUSERSETFROMFILE_S     _MESSAGE(23197, _("error reading userset from file " PFNMAX))
...
#define MSG_ANSWER_ERRORREADINGCONFIGFROMFILEX_S   _MESSAGE(23206, _("error reading configuration from file " PFNMAX))
...
#define MSG_JOB_CANNOT_REMOVE_SS                   _MESSAGE(23229, _("can not remove file " PFNMAX ": " SFN))
...
#define MSG_ERROROPENINGFILEFORREADING_SS _MESSAGE(60203, _("error opening file " PFQMAX " for reading: " SFN))
#define MSG_ERROROPENINGFILEFORWRITING_SS _MESSAGE(60204, _("error opening file " PFQMAX " for writing: " SFN))
#define MSG_ERRORCLOSINGFILE_SS           _MESSAGE(60205, _("error closing file " PFQMAX ": " SFN))
#define MSG_ERRORFLUSHINGFILE_SS          _MESSAGE(60206, _("error flushing file " PFQMAX ": " SFN))
#define MSG_ERRORWRITINGFILE_SS           _MESSAGE(60207, _("error writing to file " PFQMAX ": " SFN))
#define MSG_ERRORFSYNCINGFILE_SS          _MESSAGE(60208, _("error syncing file " PFQMAX " to disk: " SFN))
#define MSG_ERRORCHANGINGCWD_SS           _MESSAGE(60209, _("error changing current working directory to " PFNMAX ": " SFN))
#define MSG_ERRORRENAMING_SSS             _MESSAGE(60210, _("error renaming file " PFQMAX " to " SFQ ": " SFN))
#define MSG_ERRORDELETINGFILE_SS          _MESSAGE(60211, _("error deleting file " PFQMAX ": " SFN))
