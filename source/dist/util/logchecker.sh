...
#___INFO__MARK_END__
#
# This is a template script for moving, deleting, compressing Cluster Scheduler
...
# Cluster Scheduler system is running under an admin_user id, make sure to run
