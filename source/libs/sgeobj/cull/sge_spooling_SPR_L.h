...
LISTDEF(SPR_Type)
   ...
   SGE_REF(SPR_option_func, CULL_ANY_SUBTYPE, CULL_NO_TRANSFER)
   SGE_REF(SPR_startup_func, CULL_ANY_SUBTYPE, CULL_NO_TRANSFER)
   SGE_REF(SPR_shutdown_func, CULL_ANY_SUBTYPE, CULL_NO_TRANSFER)
   SGE_REF(SPR_maintenance_func, CULL_ANY_SUBTYPE, CULL_NO_TRANSFER)
   SGE_REF(SPR_trigger_func, CULL_ANY_SUBTYPE, CULL_NO_TRANSFER)
   SGE_REF(SPR_transaction_func, CULL_ANY_SUBTYPE, CULL_NO_TRANSFER)
   SGE_REF(SPR_list_func, CULL_ANY_SUBTYPE, CULL_NO_TRANSFER)
   SGE_REF(SPR_read_func, CULL_ANY_SUBTYPE, CULL_NO_TRANSFER)
   SGE_REF(SPR_read_keys_func, CULL_ANY_SUBTYPE, CULL_NO_TRANSFER)
   SGE_REF(SPR_write_func, CULL_ANY_SUBTYPE, CULL_NO_TRANSFER)
   SGE_REF(SPR_delete_func, CULL_ANY_SUBTYPE, CULL_NO_TRANSFER)
   SGE_REF(SPR_validate_func, CULL_ANY_SUBTYPE, CULL_NO_TRANSFER)
   SGE_REF(SPR_validate_list_func, CULL_ANY_SUBTYPE, CULL_NO_TRANSFER)
   SGE_REF(SPR_clientdata, CULL_ANY_SUBTYPE, CULL_NO_TRANSFER)
LISTEND
