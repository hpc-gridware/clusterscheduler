...
LISTDEF(EV_Type)
   ...
   SGE_REF(EV_sub_array, CULL_ANY_SUBTYPE, CULL_NO_TRANSFER)
   SGE_ULONG(EV_state, CULL_DEFAULT)
   SGE_REF(EV_update_function, CULL_ANY_SUBTYPE, CULL_NO_TRANSFER)
   SGE_REF(EV_update_function_arg, CULL_ANY_SUBTYPE, CULL_NO_TRANSFER)
LISTEND
