...
LISTDEF(LDR_Type)
   ...
   SGE_REF(LDR_global, CULL_ANY_SUBTYPE, CULL_NO_TRANSFER)
   SGE_REF(LDR_host, CULL_ANY_SUBTYPE, CULL_NO_TRANSFER)
   SGE_REF(LDR_queue, CULL_ANY_SUBTYPE, CULL_NO_TRANSFER)
LISTEND
