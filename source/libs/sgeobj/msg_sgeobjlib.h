...
#define MSG_RSMAP_TOO_MANY_IMPLICIT_IDS_SUU    _MESSAGE(64578, _("RSMAP " SFQ " would create " sge_u32 " ids implicitly, which exceeds the limit of " sge_u32 " - list the ids explicitly or raise MAX_RSMAP_IDS in qmaster_params"))
#define MSG_RSMAP_PARAM_UNCLOSED_SS            _MESSAGE(64579, _("RSMAP " SFQ ": the parameter list " SFQ " is not closed"))
#define MSG_RSMAP_PARAM_TRAILING_SSS           _MESSAGE(64580, _("RSMAP " SFQ ": " SFQ " follows the parameter list in " SFQ))
#define MSG_RSMAP_PARAM_EMPTY_SS               _MESSAGE(64581, _("RSMAP " SFQ ": empty parameter in " SFQ))
