...
/** @brief The attribute ids of JAT, terminated by ocs::AttributeStatic::END_OF_ATTRIBUTES
 *
...
/** @brief The compile-time description of every attribute of JAT
 *
