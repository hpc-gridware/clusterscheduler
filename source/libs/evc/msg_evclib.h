...
#define MSG_EVENT_HIGHESTEVENTISXWHILEWAITINGFORY_UU  _MESSAGE(65001, _("highest event number is " sge_uu32 " while waiting for " sge_uu32))
#define MSG_EVENT_SMALLESTEVENTXISGRTHYWAITFOR_UU     _MESSAGE(65002, _("smallest event number " sge_uu32 " is greater than number " sge_uu32 " i'm waiting for"))
...
#define MSG_EVENT_ILLEGAL_ID_OR_NAME_US               _MESSAGE(65005, _("Illegal id " sge_uu32 " or name " SFQ " in event client registration"))
