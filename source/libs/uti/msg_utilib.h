...
#define MSG_COMMAND_NOFILESTATUS_S  _MESSAGE(49004, _("can't determine file status of command " PFQMAX))
...
#define MSG_FILE_NOCDTODIRECTORY_S           _MESSAGE(49016, _("can't change to directory " PFQMAX))
...
#define MSG_FILE_OPENDIRFAILED_SS            _MESSAGE(49020, _("opendir(" PFNMAX ") failed: " SFN))
...
#define MSG_FILE_UNLINKFAILED_SS             _MESSAGE(49023, _("unlink(" PFNMAX ") failed: " SFN))
#define MSG_FILE_RMDIRFAILED_SS              _MESSAGE(49024, _("rmdir(" PFNMAX ") failed: " SFN))
...
#define MSG_FILE_OPENFAILED_S                   _MESSAGE(49050, _("cant open file " PFQMAX))
#define MSG_FILE_WRITEBYTESFAILED_IS            _MESSAGE(49051, _("cant write %d bytes into file " PFQMAX))
...
#define MSG_FILE_CREATEDIRFAILED_SS             _MESSAGE(49077, _("can't create directory " PFQMAX ": " SFN))
...
#define MSG_UTI_DIRECTORYNOTEXIST_S             _MESSAGE(49111, _("directory doesn't exist: " PFNMAX))
#define MSG_SGETEXT_NOSGECELL_S                 _MESSAGE(49112, _("cell directory " PFQMAX " doesn't exist"))
...
#define MSG_SMF_CONTRACT_CONTROL_OPEN_FAILED_S  _MESSAGE(59148, _("can't open contract ctl file: " PFQMAX))
...
#define MSG_TMPNAM_SGE_MAX_PATH_LENGTH_US       _MESSAGE(59162, _("reached max path length of " sge_u32 " bytes for file " PFQMAX))
#define MSG_TMPNAM_GOT_SYSTEM_ERROR_SS          _MESSAGE(59163, _("got system error " SFQ " while checking file in " PFQMAX))
...
#define MSG_SGETEXT_SGEROOTNOTFOUND_S           _MESSAGE(59218, _("SGE_ROOT directory " PFQMAX " doesn't exist"))
...
#define MSG_OPENSSL_CANNOT_PERM_CERT_DIR_SS        _MESSAGE(59299, _("cannot set permissions on certificate directory " PFQMAX ": " SFN4))
#define MSG_OPENSSL_CANNOT_PERM_KEY_DIR_SS         _MESSAGE(59300, _("cannot set permissions on key directory " PFQMAX ": " SFN4))
...
#define MSG_OPENSSL_CANNOT_OPEN_CERT_FILE_SS       _MESSAGE(59303, _("cannot open certificate file: " PFQMAX ": " SFN4))
#define MSG_OPENSSL_CANNOT_READ_CERT_FILE_S        _MESSAGE(59304, _("cannot read from certificate file: " PFQMAX))
...
#define MSG_OPENSSL_CANNOT_USE_KEY_FILE_SS         _MESSAGE(59310, _("cannot use private key file: " PFQMAX ": " SFN4))
#define MSG_OPENSSL_CERT_KEY_MISMATCH_SSS          _MESSAGE(59312, _("certificate " PFQMAX " and private key " PFQMAX " do not belong together; the certificate was created by installation " SFN4 " - remove the stale file or reinstall"))
