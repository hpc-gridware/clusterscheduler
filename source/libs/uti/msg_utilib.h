...
#define MSG_CANNOT_CREATE_SSL_S                    _MESSAGE(59284, _("cannot create SSL: " SFN4))
#define MSG_CANNOT_SET_FD_S                        _MESSAGE(59285, _("cannot set file descriptor to SSL: " SFN4))
#define MSG_CANNOT_READ_DS                         _MESSAGE(59286, _("cannot read from SSL: %d: " SFN4))
#define MSG_CANNOT_WRITE_DS                        _MESSAGE(59287, _("cannot write to SSL: %d: " SFN4))
#define MSG_CANNOT_ACCEPT_DS                       _MESSAGE(59288, _("cannot SSL accept connection: %d: " SFN4))
#define MSG_CANNOT_SET_SERVERNAME_S                _MESSAGE(59289, _("cannot set server name for SSL SNI: " SFN4))
#define MSG_CANNOT_CONNECT_DS                      _MESSAGE(59290, _("cannot SSL connect: %d: " SFN4))
#define MSG_SSL_SELECT_TIMEOUT                     _MESSAGE(59291, _("SSL select timeout after WANT_READ/WRITE"))
#define MSG_SSL_SELECT_FAILED_DS                   _MESSAGE(59292, _("SSL select failed: %d: " SFN4))
#define MSG_SSL_ACCEPT_CALLED_ON_CLIENT            _MESSAGE(59293, _("SSL accept called on client connection"))
#define MSG_SSL_CONNECT_CALLED_ON_SERVER           _MESSAGE(59293, _("SSL connect called on server connection"))
#define MSG_SSL_NOT_BUILT_IN                       _MESSAGE(59294, _("SSL support is not built in"))
