...
#define MSG_CL_TCP_FW_ENDPOINT_X_DOESNT_MATCH_Y_SSUSSU                        _MESSAGE(85026, _("local endpoint \"" SFN "/" SFN "/" sge_uu32 "\" doesn't match requested endpoint \"" SFN "/" SFN "/" sge_uu32 "\""))
#define MSG_CL_TCP_FW_ENDPOINT_X_ALREADY_CONNECTED_SSU                        _MESSAGE(85027, _("endpoint \"" SFN "/" SFN "/" sge_uu32 "\" is already connected"))
...
#define MSG_CL_TCP_FW_ENDPOINT_X_NOT_FROM_RESERVED_PORT_SSU                   _MESSAGE(85037, _("debug client \"" SFN "/" SFN "/" sge_uu32 "\" did not use a reserved port below 1024"))
#define MSG_CL_TCP_FW_ENDPOINT_X_NOT_FROM_LOCAL_HOST_SSUS                     _MESSAGE(85038, _("debug client \"" SFN "/" SFN "/" sge_uu32 "\" is not running on host " SFQ ""))
#define MSG_CL_TCP_FW_LOCAL_HOST_CONNECT_ERROR                                _MESSAGE(85039, _("debug client is not running on local host"))
#define MSG_CL_TCP_FW_STANDARD_ENDPOINT_X_NOT_FROM_RESERVED_PORT_SSU          _MESSAGE(85040, _("client \"" SFN "/" SFN "/" sge_uu32 "\" did not use a reserved port below 1024"))
...
#define MSG_CL_COMMLIB_HOSTNAME_EXEEDS_MAX_HOSTNAME_LENGTH_SU                 _MESSAGE(85047, _("hostname " SFQ " exceeds MAXHOSTNAMELEN(=" sge_uu32 ")"))
#define MSG_CL_COMMLIB_SSL_ERROR_USS                                          _MESSAGE(85048, _("SSL error(nr.:" sge_uu32 ") in %s: %s"))
...
#define MSG_CL_COMMLIB_SSL_ERROR_NR_AND_TEXT_USS      _MESSAGE(85066, _("[ID=" sge_uu32 "] in module " SFQ ": " SFQ))
