...
#define MSG_SEC_KRBAUTHFAILURE        _MESSAGE(43013, _("job " sge_uu32 " rejected because authentication failed"))
#define MSG_SEC_KRBAUTHFAILUREONHOST  _MESSAGE(43014, _("job " sge_uu32 " rejected because authentication failed on host " SFN))
#define MSG_SEC_NOCREDNOBIN_US        _MESSAGE(43017, _("could not get client credentials for job " sge_uu32 " - " SFN " binary does not exist"))
...
#define MSG_SEC_KRBDECRYPTTGT_US      _MESSAGE(43019, _("could not decrypt TGT for job " sge_uu32 "- " SFN))
#define MSG_SEC_KRBENCRYPTTGT_SSIS    _MESSAGE(43020, _("could not encrypt TGT for client <" SFN "," SFN ",%d> - " SFN))
#define MSG_SEC_KRBENCRYPTTGTUSER_SUS _MESSAGE(43021, _("could not encrypt TGT for user " SFN ", job " sge_uu32 " - " SFN))
#define MSG_SEC_NOUID_SU              _MESSAGE(43022, _("could not get user ID for " SFN ", job " sge_uu32))
...
#define MSG_GDI_CANT_SEND_MSG_TO_PORT_ON_HOST_SUSS       _MESSAGE(43118, _("unable to send message to " SFN " using port " sge_uu32 " on host " SFQ ": " SFN))
#define MSG_GDI_UNABLE_TO_CONNECT_SUS                    _MESSAGE(43119, _("unable to contact " SFN " using port " sge_uu32 " on host " SFQ))
#define MSG_GDI_GETGRGIDXFAILEDERRORX_U                  _MESSAGE(43120, _("unable to resolve group name for group ID, " sge_uu32))
...
#define MSG_GDI_ERRORUNPACKINGGDIREQUEST_SSIS            _MESSAGE(43126, _("error unpacking gdi request from %s/%s/%hu: " SFN))
...
#define MSG_GDI_CANT_GET_COM_HANDLE_SSUUS    _MESSAGE(43297, _("communication error for \"" SFN "/" SFN "/" sge_uu32 "\" running on port " sge_uu32 ": " SFQ))
#define MSG_GDI_CANT_CONNECT_HANDLE_SSUUS    _MESSAGE(43298, _("communication error for \"" SFN "/" SFN "/" sge_uu32 "\" using connect port " sge_uu32 ": " SFQ))
#define MSG_GDI_QMASTER_STILL_RUNNING        _MESSAGE(43302, _("qmaster is still running"))
#define MSG_GDI_ENDPOINT_UPTIME_UU           _MESSAGE(43303, _("endpoint is up since " sge_uu32 " seconds and has status " sge_uu32))
