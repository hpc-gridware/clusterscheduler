...
#define MSG_GDI_SENDMESSAGETOCOMMPROCFAILED_SSISS     _MESSAGE(43051, _("can't send " SFN "synchronous message to commproc (" SFN ":%d) on host " SFQ ": " SFN4))
#define MSG_GDI_RHOSTISNULLFORGETANYREQUEST           _MESSAGE(43052, _("parameter rhost = nullptr for sge_get_any_request()"))
#define MSG_GDI_RECEIVEMESSAGEFROMCOMMPROCFAILED_SISS _MESSAGE(43053, _("can't receive message from commproc (" SFN ":%d) on host " SFQ ": " SFN4))
...
#define MSG_GDI_SENDTASKTOEXECDFAILED_SS                 _MESSAGE(43073, _("failed sending task to execd@" SFN ": " SFN4))
#define MSG_GDI_TASKNOTEXIST_S                           _MESSAGE(43074, _("task " SFQ " does not exist"))
#define MSG_GDI_MESSAGERECEIVEFAILED_SI                  _MESSAGE(43076, _("failed receiving message from execd: " SFN4 " %d"))
...
#define MSG_GDI_CANT_SEND_MSG_TO_PORT_ON_HOST_SUSS       _MESSAGE(43118, _("unable to send message to " SFN " using port " sge_u32 " on host " SFQ ": " SFN4))
...
#define MSG_GDI_RECEIVEGDIREQUESTFAILED_US               _MESSAGE(43122, _("failed receiving gdi request response for mid=" sge_u32 " (" SFN4 ")."))
...
#define MSG_GDI_GENERAL_COM_ERROR_SS   _MESSAGE(43294, _("commlib error: " SFN4 " (" SFN2")"))
#define MSG_GDI_GENERAL_COM_ERROR_S    _MESSAGE(43292, _("commlib error: " SFN4 ))
...
#define MSG_GDI_CANT_GET_COM_HANDLE_SSUUS    _MESSAGE(43297, _("communication error for \"" SFN "/" SFN "/" sge_u32 "\" running on port " sge_u32 ": " SFN4))
#define MSG_GDI_CANT_CONNECT_HANDLE_SSUUS    _MESSAGE(43298, _("communication error for \"" SFN "/" SFN "/" sge_u32 "\" using connect port " sge_u32 ": " SFN4))
