...
#define MSG_SCHEDD_INFO_PESLOTSNOTINRANGE_SI          _MESSAGE(47065, _("cannot run in PE " SFQ " because it only offers " sge_uu32 " slots"))
...
#define MSG_SCHEDD_INFO_CANNOTRUNINQUEUECAL_SU        _MESSAGE(47137, _("cannot run in queue instance " SFQ " because the job runtime of " sge_uu32 " sec. is too long"))
...
#define MSG_SCHEDD_INFO_QINOTARRESERVED_SI            _MESSAGE(47146, _("cannot run in queue instance " SFQ " because it was not reserved by advance reservation " sge_uu32))
...
#define MSG_SCHEDD_INFO_QNOTARRESERVED_SI             _MESSAGE(47148, _("cannot run in queue " SFQ " because it was not reserved by advance reservation " sge_uu32))
...
#define MSG_SCHEDD_INFO_ARISINERROR_I                 _MESSAGE(47150, _("cannot run because requested advance reservation " sge_uu32 " is in error state"))
...
#define MSG_SCHEDD_INFO_HNOTARRESERVED_SI             _MESSAGE(47152, _("cannot run on host " SFQ " because it was not reserved by advance reservation " sge_uu32))
...
#define MSG_SCHEDD_SHOULDHAVEFINISHED_UUU                   _MESSAGE(47209, _("job " sge_uu32 "." sge_uu32 " should have finished since " sge_uu32 "s"))
...
#define MSG_SUBORDPOLICYCONFLICT_UUSS                       _MESSAGE(47227, _("Jobs " sge_uu32 " & " sge_uu32 " dispatched to master/subordinated queues " SFQ "/" SFQ ". Suspend on subordinate to occur in same scheduling interval. Policy conflict!"))
...
#define MSG_ATTRIB_USINGXFORY_US                _MESSAGE(47256, _("using " sge_uu32 " for " SFN))
...
#define MSG_CANTFINDTASKINJOB_UU                      _MESSAGE(47361, _("could not find task " sge_uu32 " in job " sge_uu32))
