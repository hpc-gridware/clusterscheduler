...
#define MSG_SCHEDD_SAMEIDJOBNOTFULLFILLED_SS          _MESSAGE(47415, _("resource map " SFQ " does not have enough free instances sharing one " SFN " across the hosts of the job"))
