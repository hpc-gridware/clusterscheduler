 ...
 *
 * The limit list, the two skip lists and the chosen resource map instances are only valid for
 * one point in time, so they have to go whenever the assignment is retried at a different one.
 *
 * @param[in,out] a the assignment
 */
