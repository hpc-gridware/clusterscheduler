...
#define MSG_BERKELEY_COULDNTSETBYTEORDER_IS           _MESSAGE(70009, _("error setting database byte order: (%d) " SFN))
#define MSG_BERKELEY_NULLVALUEASKEY                   _MESSAGE(70010, _("null value given as object primary key"))
#define MSG_BERKELEY_SKIP_TRIGGER_AFTER_STARTUP       _MESSAGE(70011, _("skip database trigger immediately after startup"))
