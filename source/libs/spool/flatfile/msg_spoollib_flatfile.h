...
#define MSG_FLATFILE_ERROR_READINGFILE_S     _MESSAGE(62013, _("error reading file: " PFQMAX))
#define MSG_SPOOL_INCORRECTSPOOLDIRPATH      _MESSAGE(62014, _("incorrect path given for the spool directory"))
#define MSG_SPOOL_SPOOLDIRDOESNOTEXIST_S     _MESSAGE(62016, _("spool directory " PFQMAX " does not exist"))
