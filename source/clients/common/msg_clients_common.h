...
#define MSG_QSTAT_PRT_FINISHEDJOBS                                                                                     \
   _MESSAGE(1040, _(" --  FINISHED JOBS  -  FINISHED JOBS  -  FINISHED JOBS  -  FINISHED JOBS  --  "))
#define MSG_QSTAT_PRT_PEDINGJOBS                                                                                       \
   _MESSAGE(1041, _(" - PENDING JOBS - PENDING JOBS - PENDING JOBS - PENDING JOBS - PENDING JOBS"))
