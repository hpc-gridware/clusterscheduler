...
#include "ocs_qrstat_report_handler_xml.h"
#include "ocs_qrstat_report_handler_stdout.h"
...
int main(int argc, const char **argv) {
    ...
    */
   {
      answer_list = sge_gdi(ocs::GdiTarget::Target::SGE_AR_LIST, SGE_GDI_GET, &qrstat_env.ar_list,
