...
static int qstat_env_get_all_lists(qstat_env_t* qstat_env, bool need_job_list, lList** alpp) 
{
   ...
   if (queue_l) {
      ...
      q_id = sge_gdi2_multi(alpp, SGE_GDI_RECORD, SGE_CQ_LIST, SGE_GDI_GET, nullptr, nullptr, q_all, &state, true);
      lFreeWhat(&q_all);
   ...
   */
   if (job_l) {
      ...
      j_id = sge_gdi2_multi(alpp, SGE_GDI_RECORD, SGE_JB_LIST, SGE_GDI_GET, nullptr, where, what, &state, true);
      lFreeWhere(&where);
   ...
   */
   if (zombie_l && show_zombies) {
      ...
      z_id = sge_gdi2_multi(alpp, SGE_GDI_RECORD, SGE_ZOMBIE_LIST, SGE_GDI_GET, nullptr, zw, qstat_get_JB_Type_filter(qstat_env),  &state, true);
      lFreeWhere(&zw);
   ...
   */
   ...
   ce_id = sge_gdi2_multi(alpp, SGE_GDI_RECORD, SGE_CE_LIST, SGE_GDI_GET, nullptr, nullptr, ce_all, &state, true);
   lFreeWhat(&ce_all);
   ...
   */
   ...
   eh_id = sge_gdi2_multi(alpp, SGE_GDI_RECORD, SGE_EH_LIST, SGE_GDI_GET, nullptr, where, eh_all, &state, true);
   lFreeWhat(&eh_all);
   lFreeWhere(&where);
   ...
   */ 
   if (pe_l) {   
      ...
      pe_id = sge_gdi2_multi(alpp, SGE_GDI_RECORD, SGE_PE_LIST, SGE_GDI_GET, nullptr, nullptr, pe_all, &state, true);
      lFreeWhat(&pe_all);
   ...
   */ 
   if (ckpt_l) {
      ...
      ckpt_id = sge_gdi2_multi(alpp, SGE_GDI_RECORD, SGE_CK_LIST, SGE_GDI_GET, nullptr, nullptr, ckpt_all, &state, true);
      lFreeWhat(&ckpt_all);
   ...
   */ 
   if (acl_l) {
      ...
      acl_id = sge_gdi2_multi(alpp, SGE_GDI_RECORD, SGE_US_LIST, SGE_GDI_GET, nullptr, nullptr, acl_all, &state, true);
      lFreeWhat(&acl_all);
   ...
   */ 
   if (project_l) {
      ...
      up_id = sge_gdi2_multi(alpp, SGE_GDI_RECORD, SGE_PR_LIST, SGE_GDI_GET, nullptr, nullptr, up_all, &state, true);
      lFreeWhat(&up_all);
   ...
   */
   ...
   sc_id = sge_gdi2_multi(alpp, SGE_GDI_RECORD, SGE_SC_LIST, SGE_GDI_GET, nullptr, nullptr, sc_what, &state, true);
   lFreeWhat(&sc_what);
   ...
   */
   ...
   hgrp_id = sge_gdi2_multi(alpp, SGE_GDI_RECORD, SGE_HGRP_LIST, SGE_GDI_GET, nullptr, nullptr, hgrp_what, &state, true);
   lFreeWhat(&hgrp_what);
