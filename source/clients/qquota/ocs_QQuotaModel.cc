...
bool ocs::QQuotaModel::fetch_data(lList **answer_list, QQuotaParameter &parameter) {
   DENTER(TOP_LAYER);
   ...
   /* --- complex attribute */
   lFreeList(answer_list);
   gdi_multi.get_response(answer_list, ocs::gdi::Command::SGE_GDI_GET, ocs::gdi::SubCommand::SGE_GDI_SUB_NONE, ocs::gdi::Target::SGE_CE_LIST, ce_id, &centry_list);
   if (answer_list_has_error(answer_list)) {
      DRETURN(false);
   }
   /* --- usersets */
   lFreeList(answer_list);
   gdi_multi.get_response(answer_list, ocs::gdi::Command::SGE_GDI_GET, ocs::gdi::SubCommand::SGE_GDI_SUB_NONE, ocs::gdi::Target::SGE_US_LIST, userset_id, &userset_list);
   if (answer_list_has_error(answer_list)) {
      DRETURN(false);
   }
   /* --- hostgroups */
   lFreeList(answer_list);
   gdi_multi.get_response(answer_list, ocs::gdi::Command::SGE_GDI_GET, ocs::gdi::SubCommand::SGE_GDI_SUB_NONE, ocs::gdi::Target::SGE_HGRP_LIST, hgroup_id, &hgroup_list);
   if (answer_list_has_error(answer_list)) {
      DRETURN(false);
   }
   /* --- exec hosts*/
   lFreeList(answer_list);
   gdi_multi.get_response(answer_list, ocs::gdi::Command::SGE_GDI_GET, ocs::gdi::SubCommand::SGE_GDI_SUB_NONE, ocs::gdi::Target::SGE_EH_LIST, eh_id, &hgroup_list);
