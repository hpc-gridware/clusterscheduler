...
if(NOT DEFINED _os_release_info)
  ...
  function(get_os_release_info _vn_id _vn_version_id _vn_codename)
    ...
    if("${_var_id}" STREQUAL "")
      ...
      message("UNAME WAS ${_uname}")
      if(NOT "${_uname}" STREQUAL "")
        execute_process(COMMAND ${_uname} -s OUTPUT_VARIABLE _var_id)
        execute_process(COMMAND ${_uname} -r OUTPUT_VARIABLE _var_version_id)
        execute_process(COMMAND ${_uname} -m OUTPUT_VARIABLE _var_codename)
      endif()
    endif()
